...
const MIGRATIONS = [
  ...
  "ALTER TABLE pos_data.sales ADD COLUMN IF NOT EXISTS paid_amount NUMERIC DEFAULT 0",
...
const PUBLIC_PRODUCTS_MIGRATIONS = [
  ...
  "ALTER TABLE public.products ALTER COLUMN details DROP NOT NULL",
  "ALTER TABLE public.products ALTER COLUMN details SET DEFAULT ''",
...
BEGIN
  ...
  INSERT INTO public.products (
    ...
    NEW.supplier_id,
    COALESCE(NEW.description, NEW.product_name, ''),
    NEW.variants,
